...
export default function HomePage() {
  ...
  useEffect(() => {
    if (screenWidth !== 1000) {
      const heartData: HeartType[] = [...Array(6)].map(() => ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-black text-white overflow-hidden relative font-inter">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-40 h-40 bg-pink-500/5 rounded-full blur-3xl" />
        <div className="absolute top-1/3 right-20 w-48 h-48 bg-purple-500/5 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-1/4 w-44 h-44 bg-blue-500/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/3 w-36 h-36 bg-pink-400/5 rounded-full blur-3xl" />
      </div>
